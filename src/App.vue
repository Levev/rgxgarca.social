...
<template>
    <main class="overflow-hidden w-screen h-dvh bg-(image:--cover) bg-tuff md:py-10">
        <div class="w-full md:w-(--panel-w) h-full relative m-auto flex flex-col md:gap-3 items-center overflow-hidden p-4 md:p-12 md:rounded-4xl bg-neutral-900/10 backdrop-blur-lg md:border-2 border-white/10 shadow-2xl/60 text-white">
            ...
            <SocialButton icon="line-md:spotify" title="rg x garca · Spotify" data-umami-event="spotify-expand" desc="Vége az I-skolanak" link-text="Nyissuk meg öcsipók" link="https://open.spotify.com/artist/51aizcUAA7QuxTN9KBQcT1" class="mt-12">
            ...
            <SocialButton icon="line-md:youtube" title="rg x garca · Youtube" data-umami-event="youtube-expand" desc="Vége az I-skolanak" link-text="Nyissuk meg öcsipók" link="https://youtube.com/@rgxgarca" class="mt-3">
            ...
            <SocialButton icon="line-md:instagram" title="rg x garca · Instagram" data-umami-event="instagram-visit" desc="Vége az I-skolanak" link="https://www.instagram.com/rg_x_garca/" class="mt-3" />
            <SocialButton icon="line-md:tiktok" title="rg x garca · TikTok" data-umami-event="tiktok-visit" desc="Vége az I-skolanak" link="https://www.tiktok.com/@rg_x_garca" class="mt-3" />
...
const share = () => navigator.share({
    title: "rg x garca saját socials oldala",
    url: "https://rgxgarca.social"
});
</script>
